...
class LMHeadModel(MambaLMHeadModel):
    ...
    def forward(self, input_ids, targets=None, position_ids=None, inference_params=None, num_last_tokens=0,  **mixer_kwargs):
        # get logits from the model
        logits = super().forward(input_ids, position_ids=position_ids, inference_params=inference_params, num_last_tokens=num_last_tokens, **mixer_kwargs)
        loss = None
